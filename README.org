...
+ [[https://github.com/lujun9972/emacs-document/blob/master/linux和它的小伙伴/把Orange Pi打造成影音云存储服务器.org[*Org Src 把Orange Pi打造成影音云存储服务器.org[ conf ]*]][把Orange Pi打造成影音云存储服务器.org[*Org Src 把Orange Pi打造成影音云存储服务器.org[ conf ]*]]]		<2018-03-06>
...
+ [[https://github.com/lujun9972/emacs-document/blob/master/linux和它的小伙伴/kile编译时提示[ViewPDF]failed to start的解决方法.org][kile编译时提示[ViewPDF]failed to start的解决方法.org]]		<2017-09-06>
