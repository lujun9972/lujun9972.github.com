#+TITLE: TIL DDD战术模式：用Clojure让代码说人话
#+AUTHOR: lujun9972,Claude Code
#+TAGS: DDD Clojure 软件设计
#+DATE: [2026-05-24 Sat]
#+LANGUAGE: zh-CN
#+OPTIONS: H:6 num:nil toc:t \n:nil ::t |:t ^:nil -:nil f:t *:t <:nil
#+DESCRIPTION: 代码腐化的根因往往不是技术问题，是业务语义没有体现在代码里。DDD 战术模式提供了三层机制来解决这个问题：名称即业务语言，结构映射领域概念，约束落进代码。本文用 Clojure 和告警系统场景展示 8 个核心模式，面向 DDD 初学者。
...
- =notify-team= 和 =db/update!= 为什么非得捆在一起？能不能只升级不发通知？
