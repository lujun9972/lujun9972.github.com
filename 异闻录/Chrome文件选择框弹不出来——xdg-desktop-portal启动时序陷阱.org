#+TITLE: 浏览器文件选择框弹不出来——xdg-desktop-portal 启动时序陷阱
#+AUTHOR: lujun9972, Claude
#+TAGS: 异闻录,Linux,Chrome,Firefox,X11,systemd,xdg-desktop-portal,startx
#+DATE: [2026-06-06 五 22:00]
#+LANGUAGE:  zh-CN
...
在本案中，GTK portal 只有 =After= 和 =PartOf= ，缺少 =Requisite= 。这导致在 graphical-session.target 未激活的情况下，D-Bus 激活仍然能把它拉起来，然后它去打开一个不存在的 display ，就崩溃了。
#+END_QUOTE
